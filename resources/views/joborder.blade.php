...
<div class="container-fluid">
  ...
  <div class="container-fluid navbackgroundwhite">
    ...
    <ul class="nav navbar-nav navbar-right">
      <div class="dropdown">
        <button class="btn dropdown-toggle buttondropdown" type="button" data-toggle="dropdown"><span class="user">Administrator</span><img class="overseelogo" src="img/oversee.png" draggable="false">
  ...
  <div id="sidebar-wrapper" class="sidebar-toggle">
    <ul class="sidebar-nav">
        ...
        <li>
            <a class="activeLink" href="joborder.html">Job Order</a>
        </li>
        <li>
